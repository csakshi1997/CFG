...
struct ClosedMaintenanceModel {
    ...
    var Maintenance_Officer_Final_Remarks__c: String
    ...
    init(dict: [String: Any]?) {
        ...
        self.Maintenance_Officer_Final_Remarks__c = getStringValue("Maintenance_Officer_Final_Remarks__c")
