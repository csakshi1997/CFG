...
class ClosedCaseDetailsVC: UIViewController {
    ...
    var closingRefundModel : ClosingRefundModel?
...
//                profileAcceptedtextFldStackVw?.isHidden = true
    ...
    func autoPopulateData() {
        ...
        guard let patientDetail = closingRefundModel else {
            print("No data available in closingRefundModel")
            return
        }
        DispatchQueue.main.async {
            ...
            if (patientDetail.offerToSeeSeniorConsultantAMChecklist ?? false) {
                ...
                if (patientDetail.offerToSeeSeniorConsultantNo ?? false) {
                    ...
                    self.scheduleAppointmentStackVw?.isHidden = true
                } else {
            ...
            if patientDetail.noRefundValueCaseClose ?? false {
                self.clinicManagerStackVw?.isHidden = false
                self.clinicDoctorStackVw?.isHidden = false
                self.doctorReviewCommentsStackVw?.isHidden = false
                self.AMCheckListStackVw?.isHidden = false
                self.SeniorConsultantCommentsStackVw?.isHidden = true
                self.AMFollowUpStackVw?.isHidden = true
                self.OMCommentStackVw?.isHidden = true
                self.SystemAdminStackVw?.isHidden = true
                self.financeRemarkStackVw?.isHidden = true
            } else if patientDetail.caseCloseOMComments ?? false {
                self.clinicManagerStackVw?.isHidden = false
                self.clinicDoctorStackVw?.isHidden = false
                self.doctorReviewCommentsStackVw?.isHidden = false
                self.AMCheckListStackVw?.isHidden = false
                self.SeniorConsultantCommentsStackVw?.isHidden = false
                self.AMFollowUpStackVw?.isHidden = false
                self.OMCommentStackVw?.isHidden = false
                self.SystemAdminStackVw?.isHidden = true
                self.financeRemarkStackVw?.isHidden = true
            }
            
            if (patientDetail.offeredReviewWithCDNo ?? false) {
                self.clinicDoctorStackVw?.isHidden = true
                self.doctorReviewCommentsStackVw?.isHidden = true
            } else {
                self.clinicDoctorStackVw?.isHidden = false
                self.doctorReviewCommentsStackVw?.isHidden = false
            }
            
            self.spokenWithPatientNoButton?.isEnabled = false
            self.spokenWithPatientYesButton?.isEnabled = false
            self.spokenWithPatient?.isEnabled = false
            
            self.difficultPatientBtn?.isEnabled = false
            self.nonComplianceBtn?.isEnabled = false
            self.spokenCounselledBtn?.isEnabled = false
            self.othersBtn?.isEnabled = false
            
            self.reviewClinicManagerBtn?.isEnabled = false
            self.callPatientBtn?.isEnabled = false
            self.offerToTransferBtn?.isEnabled = false
            self.offerToTransferNoBtn?.isEnabled = false
            self.offerToTransferYesBtn?.isEnabled = false
            self.extendValidityBtn?.isEnabled = false
            self.updateSystemBtn?.isEnabled = false
            self.transferToFamilyBtn?.isEnabled = false
            self.offerToSeeSeniorConsultantBtn?.isEnabled = false
            self.offerToSeeSeniorConsultantNoBtn?.isEnabled = false
            self.offerToSeeSeniorConsultantYesBtn?.isEnabled = false
            self.scheduleAppointmnetBtn?.isEnabled = false
            self.refundWihAmountBalanceBtn?.isEnabled = false
            self.noRefundValueBtn?.isEnabled = false
            self.noRefundValueCloseCaseBtn?.isEnabled = false
            self.noRefundValuePursueWithOMBtn?.isEnabled = false
            self.speakToHigherAuthorityBtn?.isEnabled = false
            self.callPatientTextView?.isEditable = false
            self.AMTextView?.isEditable = false
            self.scheduleAppointmentTextFld?.isEnabled = false
            self.profileAcceptedtextFld?.isEnabled = false
            self.acceptanceDatetextFldBtn?.isEnabled = false
            
            self.patientToContinueWithSeniorConsultantBtn?.isEnabled = false
            self.patientToContinueWithClinicDoctoreBtn?.isEnabled = false
            self.patientToTransferBtn?.isEnabled = false
            self.refundWithAmountBtn?.isEnabled = false
            self.OtherBtn?.isEnabled = false
            
            self.PatientToContinueCareBtn?.isEnabled = false
            self.TransferFileBackToFormerClinicBtn?.isEnabled = false
            self.PatientToTransferToOtherDoctorBtn?.isEnabled = false
            self.transferFileBtn?.isEnabled = false
            self.refundWithAmountBalanceBtn?.isEnabled = false
            self.TransferFileBackAcceptanceTextField?.isEnabled = false
            self.PatientToTransferAcceptanceDateTextField?.isEnabled = false
            
            self.reviewApprovedRefundBtn?.isEnabled = false
            self.caseClosedBtn?.isEnabled = false
            
            self.reviewedBtn?.isEnabled = false
            self.approvedBtn?.isEnabled = false
...
//        manageScreenAccordingToRole()
    ...
    func manageScreenAccordingToRole() {
        ...
        if closingRefundModel?.status == "Pending" && userRoleEnum == "Clinic FD/Supervisors" {
            ...
            spokenWithPatientNoTotalTxtCount?.text = ""
            return
        } else if closingRefundModel?.status == "Pending AM/Doctor Comments" && userRoleEnum == "Doctor" && (closingRefundModel?.offeredReviewWithCDNo ?? false) {
            ...
            financeRemarkStackVw?.isHidden = true
            return
        } else if closingRefundModel?.status == "Pending Review with Clinic Doctor" && userRoleEnum == "Doctor" &&  (!(closingRefundModel?.nonComplianceOnCPFrequencyVisit ?? true) && !(closingRefundModel?.spokenCounselledMultipleTimes ?? true) && !(closingRefundModel?.clinicDoctorOthers ?? true) && !(closingRefundModel?.difficultPatientAlwaysComplaining ?? true)) {
        ...
        } else if closingRefundModel?.status == "Pending Review with Clinic Doctor" && userRoleEnum == "Doctor" && ((closingRefundModel?.nonComplianceOnCPFrequencyVisit ?? false) || (closingRefundModel?.spokenCounselledMultipleTimes ?? false) || (closingRefundModel?.clinicDoctorOthers ?? false) || (closingRefundModel?.difficultPatientAlwaysComplaining ?? false)) {
            ...
            financeRemarkStackVw?.isHidden = true
            return
        } else if closingRefundModel?.status == "Pending AM Review" && userRoleEnum == "AM" {
            spokenWithPatientNoButton?.isEnabled = false
            spokenWithPatientYesButton?.isEnabled = false
            spokenWithPatient?.isEnabled = false
            ...
            financeRemarkStackVw?.isHidden = true
            return
        } else if closingRefundModel?.status == "Pending Senior Consultant Review" && userRoleEnum == "Senior Consultant" {
            spokenWithPatientNoButton?.isEnabled = false
            spokenWithPatientYesButton?.isEnabled = false
            spokenWithPatient?.isEnabled = false
            ...
            financeRemarkStackVw?.isHidden = true
            return
        } else if closingRefundModel?.status == "Pending AM Follow Up" && userRoleEnum == "AM" {
            spokenWithPatientNoButton?.isEnabled = false
            spokenWithPatientYesButton?.isEnabled = false
            spokenWithPatient?.isEnabled = false
            ...
            financeRemarkStackVw?.isHidden = true
            return
        }  else if closingRefundModel?.status == "Pending OM Review"  && userRoleEnum == "OM" {
            spokenWithPatientNoButton?.isEnabled = false
            spokenWithPatientYesButton?.isEnabled = false
            spokenWithPatient?.isEnabled = false
            ...
            financeRemarkStackVw?.isHidden = true
            return
        } else if closingRefundModel?.status == "Pending System Admin Approval" && (userRoleEnum == "Admin" || userRoleEnum == "OM") {
            spokenWithPatientNoButton?.isEnabled = false
            spokenWithPatientYesButton?.isEnabled = false
            spokenWithPatient?.isEnabled = false
...
//
            ...
            financeRemarkStackVw?.isHidden = true
            return
        } else if closingRefundModel?.status == "Pending Finance Preparation"  && userRoleEnum == "Finance"  {
            spokenWithPatientNoButton?.isEnabled = false
            spokenWithPatientYesButton?.isEnabled = false
            spokenWithPatient?.isEnabled = false
...
extension ClosedCaseDetailsVC: UITextFieldDelegate, UITextViewDelegate {
